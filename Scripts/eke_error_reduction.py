...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--number_of_iterations", type=int, default=100, help="Number of iterations of ER")
    parser.add_argument("-o", "--outdir", default=".", help="Output directory")
    parser.add_argument("-a", "--affix", default="refined", help="This name will be added to all output files.")
    ...
    _spimage.sp_image_write(model_out, "%s/real_space-%s.h5" % (args.outdir, args.affix), 0)
    _spimage.sp_image_write(support_out, "%s/support-%s.h5" % (args.outdir, args.affix), 0)
    _spimage.sp_image_write(fmodel_out, "%s/fourier_space-%s.h5" % (args.outdir, args.affix), 0)
