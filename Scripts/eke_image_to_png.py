...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--mask", action="store_true", help="Output mask.")
    parser.add_argument("-c", "--colorscale", choices=("gray", "jet", "phase", "hot", "rainbow", "traditional", "weighted_phase"), default="jet",
    ...
    if args.log: output_flag |= spimage.SpColormapLogScale
    if args.mask: output_flag |= spimage.SpColormapMask
